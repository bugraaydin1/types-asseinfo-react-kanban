...
export interface AddColumnBag {
	addColumn: (board: BoardInterface, column: Column) => BoardInterface | void;
}
...
// uncontrolled board
declare function OnColumnRenameType(
	board: BoardInterface,
	column: Column
): void;
...
export interface BoardProps {
	...
	renderCard?: (
		card: Card,
		cardBag: { removeCard: typeof RemoveCardFn; dragging: boolean }
	) => JSX.Element;
	/**
	 ...
	 *	```
	 */
	onColumnRename?: (...OnColumnRenameType) => void; //column,title in controlled
	/**
 ...
 * * Use with `onCardDragEnd` callback to update state with new board returned.
 */
export declare function moveCard(
	board: BoardInterface,
	from: CardSource,
	to: CardDestination
): BoardInterface;
...
/**
 * * Use in controlled board when `renderColumnHeader` prop
 */
